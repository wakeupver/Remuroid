...
class LemuroidLibrary(
    ...
    fun getGameFiles(
        ...
        return provider.getProvider(game).getGameRomFiles(game, dataFiles)
    }
    ...
    companion object {
        ...
        // Number of directory groups scanned in parallel. Keeps all CPU cores busy during
        // the I/O-bound metadata retrieval phase without overwhelming the ContentResolver.
