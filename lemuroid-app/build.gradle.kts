...
android {
    ...
    // Dynamic feature modules (lemuroid-cores) removed.
    // Cores are now downloaded at runtime from the libretro nightly buildbot.
    ...
    packaging {
        jniLibs {
            ...
            // arm64-only: exclude all other ABI native libs
            excludes += setOf(
                "**/lib/armeabi-v7a/**",
                "**/lib/x86/**",
                "**/lib/x86_64/**"
...
dependencies {
    ...
    // bundled-cores removed: using libretro nightly buildbot instead.
