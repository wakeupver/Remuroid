...
class BaseGameScreenViewModel(
    ...
    private inline fun withLoading(block: () -> Unit) {
        ...
        try {
            ...
            // Guaranteed reset even if block() throws or returns early,
            // preventing the UI from being permanently stuck in loading state.
    ...
    fun getAspectRatioFlow() = settingsManager.aspectRatioFlow()

    fun getCustomAspectXFlow() = settingsManager.customAspectXFlow()

    fun getCustomAspectYFlow() = settingsManager.customAspectYFlow()
